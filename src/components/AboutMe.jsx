  ...
  return (
    <section id="about" className="max-w-screen-xl px-6 mx-auto py-10 md:py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 md:gap-4">
        <img src={taqi} alt="Hero" className="w-full h-100 object-cover rounded-lg mb-2 md:mb-0 " /> 
     
        <div className='col-span-2 text-lg bg-gradient-to-br from-blue-950 to-slate-900 rounded-lg border border-blue-800/40 p-6'> 
     ...
     <InfoCard cl lable="Years of Experience" count={ABOUT_ME_DATA.stats.yearsOfExperience} />
...
const InfoCard = ({ lable, count }) => {
  return (
    <div className="bg-gradient-to-br hover:from-blue-200  hover:text-blue-950 from-blue-950 to-slate-900 rounded-lg border border-blue-800/40 px-4 md:px-6 py-3">
      <h6 className="text-[var(--primary)] text-xl md:text-2xl font-bold">{count}</h6>
      <span className="text-xs md:text-sm  font-semibold">{lable}</span>
    </div>
  )
}
